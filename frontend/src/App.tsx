...
import LabList from './features/labs/LabList';
...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'labs',
        element: <ProtectedRoute allowedRoles={[UserRole.Admin, UserRole.Doctor, UserRole.LabTechnician]}><LabList /></ProtectedRoute>,
      },
      {
        path: 'audit',
